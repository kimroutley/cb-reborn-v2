...
class GhostLoungeView extends StatelessWidget {
    ...
    return CBPrismScaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final spectatorPanel = _buildSpectatorPanel(context, textTheme, scheme);
          final intelPanel = _buildIntelPanel(textTheme, scheme);
  ...
  Widget _buildSpectatorPanel(BuildContext context, TextTheme textTheme, ColorScheme scheme) {
    return CBPanel(
  ...
  Widget _buildIntelPanel(TextTheme textTheme, ColorScheme scheme) {
    return CBPanel(
