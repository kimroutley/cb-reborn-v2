...
class MockGeminiNarrationService extends Mock
    implements GeminiNarrationService {}
...
void main() {
  group('Dual-Track Night Narration', () {
    ...
    test('dispatches only mechanical host recap when AI is disabled', () {
      ...
      expect(aiRecaps, isEmpty,
          reason: 'Should not have any AI recaps when AI is off.');
    });
  });
}
