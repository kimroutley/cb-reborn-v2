...
final lobbyProfilesProvider = StreamProvider.autoDispose<Map<String, Map<String, dynamic>>>((ref) {
  final gameState = ref.watch(gameProvider);
  final uids = gameState.players
      .map((p) => p.authUid)
...
Stream<Map<String, Map<String, dynamic>>> _combineLatestMaps(
  ...
  final values = List<Map<String, Map<String, dynamic>>?>.filled(streams.length, null);
