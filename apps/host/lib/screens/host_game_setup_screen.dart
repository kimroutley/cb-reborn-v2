            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  CBFadeSlide(
                    ...
                    child: CBGlassTile(
                      ...
                      padding: const EdgeInsets.symmetric(
                          horizontal: CBSpace.x5, vertical: CBSpace.x3),
                      child: Row(
                        children: [
                          Container(
                  ...
                  const CBFeedSeparator(label: 'OPERATIVE ROSTER'),
                  const SizedBox(height: CBSpace.x3),
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        if (!isManualStyle && hasAssigned) const SizedBox(width: CBSpace.x3),
        if (hasAssigned)
          Expanded(
            child: CBGhostButton(
              label: 'CLEAR ALL',
...
class _SetupLaunchBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (!allAssigned) {
      ...
      badgeText = canStart ? '$playerCount READY' : '$playerCount READY';
